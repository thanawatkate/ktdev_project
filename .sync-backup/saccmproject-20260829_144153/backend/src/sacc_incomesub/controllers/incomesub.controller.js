const service = require('../services/incomesub.service');
...
async function createIncomeSub(refincome, data, headerCtx, trx) {
  return await service.createIncomeSub(refincome, data, headerCtx, trx);
}
