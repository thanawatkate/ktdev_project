doc: https://knexjs.org/guide/migrations.html#migration-cli
// new file table detail
...
// run all file in migration
knex migrate:down
// delete all file in migration
knex migrate:down
...
// ones(./migrations/_.js):
knex.migrate.latest({
migrationSource: new WebpackMigrationSource(
require.context('./migrations', false, /^\.\/._\.js$/)
)
})
...
- but if exported a default, it will take precedence, and it will be used instead
  **/
  ...
  /** this will be used, it has precedence over named export _/
  export default config;
  /\*\* Named exports, will be used if you didn't provide a default export _/
