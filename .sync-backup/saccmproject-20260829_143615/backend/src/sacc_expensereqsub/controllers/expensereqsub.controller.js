const service = require('../services/expensereqsub.service');
...
async function createInExpenseReqSub(refexpense, data) {

  return await service.createInExpenseReqSub(refexpense, data);
