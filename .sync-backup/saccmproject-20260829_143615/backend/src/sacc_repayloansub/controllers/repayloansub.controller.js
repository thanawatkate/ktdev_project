const service = require('../services/repayloansub.service');
...
async function createInRepayloanSub(refincome, data) {

  return await service.createRepayloanSub(refincome, data);
